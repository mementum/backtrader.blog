...
.. update:: Aug 11, 2015
   ...
   Following `Issue #11 <https://github.com/mementum/backtrader/issues/11>`_ a
   `development
   <https://github.com/mementum/backtrader/commit/2a3be8fcaf9cd0a7577dc2cbd31899fbd8a53143>`_
   branch was created updating the chart and output. The wrong close price was
   being used.
